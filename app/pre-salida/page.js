...
export const PreOpen = () => {
    const pages = [];
    for (const page of JsonData.pagesPreOpen) {
        ...
        }else if (page.pageName === "CountDown"){
            pages.push({e: <CountDown data={page.data} key={page.pageName + page.order}/>, order: page.order});
        }
    }
